...
namespace Pathfinding {
	...
	public abstract class AIBaseModified : VersionedMonoBehaviour {
		
		public Vector3 positionAfterMove { get; protected set; }
		public Quaternion rotationAfterMove { get; protected set; }
		...
		protected override void Awake () {
			...
			rotationAfterMove = transform.rotation;
		}
		 ...
		 * \see turningSpeed
		 */
		protected virtual Quaternion RotateTowards (Vector2 direction, float maxDegrees) {
...
//				tr.rotation = Quaternion.RotateTowards(tr.rotation, targetRotation, maxDegrees);
		...
		protected Vector3 Move (Vector3 position3D, Vector3 deltaPosition)
		{
